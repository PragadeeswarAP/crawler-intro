...
class JabongParserTest extends FunSuite with Matchers with TestUtils {
  ...
  test("should parse product page2") {
    ...
    parsedProduct.description should include("Feel enhanced breathability, maximum cushioning and stability throughout your aggressive session with these, 'Isolation' basketball shoes from Adidas. Featuring an EVA insole for comfort, non-leather upper and lining, these basketball shoes offer utmost comfort to your feet while you are busy on the court. The feathered midsole construction and TORSION")
  }
